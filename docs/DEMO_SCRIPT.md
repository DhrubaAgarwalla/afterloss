...
| 0:15–0:40 | New case → **guided setup**: About them (religion fills the law of succession) → Family ("same address", age from DOB) → Who gets paid (IFSC fills the bank) → Their bank accounts → **Passbook photo → Try a sample passbook** | "Setup asks each fact once, in the order the bank forms need it. Amazon Textract reads the passbook: bank, branch, IFSC, account number, nomination. The family just checks." |
| 0:40–0:55 | Investments tiles (MF, Zerodha, LIC) + Gmail searches → Find: **Try the sample statement** → leads appear | "We read the father's bank statement. Dividends mean ITC and Infosys shares. SIPs mean two mutual funds. And this ₹436 debit is PMJJBY: ₹2 lakh of life cover the family didn't know about. Every lead shows the lines it came from." |
| 0:55–1:10 | Official searches tab | "Government portals only show money untouched for years, so we prepare those searches with every spelling of the name and the right inputs. The family runs them; we never scrape." |
| 1:10–1:40 | Choose what to claim → **claim plan** → co-op FD plan (5 numbered steps) | "The rules engine, not the AI, picks the route: simplified, because ₹3.2 lakh is under the ₹5 lakh co-op threshold, with the RBI paragraph quoted. Documents show what's missing and how to get it." → **Generate claim pack** → show the **official Annex I-B page** filled in blue ink, ticked boxes, struck options. Then the mutual fund plan: AMFI slabs, Form T3, pre-filled claim letter. |
